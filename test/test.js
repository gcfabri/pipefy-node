...
var TEST_PIPEFY_TOKEN =
  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1c2VyIjp7ImlkIjoxNTcwNjcsImVtYWlsIjoiZ2NmYWJyaUBvdXRsb29rLmNvbSIsImFwcGxpY2F0aW9uIjo0ODk5fX0.FnBsVLDd4XaQ-IPZLFdYKBQ6JIwzZdMer8ns42kFPTIbwdArPM1ggqYvKg54cnO5VUkuCtdVtRhLziWCDTyJ0A';
...
describe('Pipefy', function() {
  describe('#getMe', function() {
    it('should return personal info from API', function() {
      return pipefy.getMe().then(function(result) {
  ...
  describe('#createOrganization', function() {
    it('should return created organization data from API', function() {
      return pipefy
        .createOrganization({ industry: 'technology', name: 'DONT DELETE' })
        .then(function(result) {
          var parsedResult = JSON.parse(result);
          ORGANIZATION_ID =
            parsedResult.data.createOrganization.organization.id;
    ...
    it('should return created pipe relation from API', function() {
      return pipefy
        ...
        .then(function(result) {
          var parsedResult = JSON.parse(result);
          PIPE_RELATION_ID =
            parsedResult.data.createPipeRelation.pipe_relation.id;
          expect(parsedResult).to.have.deep.property(
            'data.createPipeRelation.pipe_relation'
          );
        });
    });
  });
    ...
    it('should return created phase from API', function() {
      return pipefy
        .createPhase({
          ...
          name: 'To Finished',
          description:
            'This phase is to be used for cards that are to be finished',
          done: false,
    ...
    it('should return create phase field from API', function() {
      return pipefy
        ...
        .then(function(result) {
          ...
          expect(parsedResult).to.have.deep.property(
            'data.createPhaseField.phase_field'
          );
        });
    });
  });
  ...
  describe('#createComment', function() {
    it('should return created comment from API', function() {
      return pipefy
        .createComment({ card_id: CARD_ID, text: 'I added this comment' })
        .then(function(result) {
          var parsedResult = JSON.parse(result);
  ...
  describe('#getOrganizations', function() {
    it('should return organizations list from API', function() {
      return pipefy.getOrganizations().then(function(result) {
  ...
  describe('#getOrganizationById', function() {
    it('should return organization data by id from API', function() {
      return pipefy.getOrganizationById(ORGANIZATION_ID).then(function(result) {
  ...
  describe('#getPipesByIds', function() {
    it('should return pipes data by ids from API', function() {
      return pipefy
        .getPipesByIds([PIPE_ID, CLONE_PIPE_ID])
        .then(function(result) {
  ...
  describe('#getPipeById', function() {
    it('should return pipe data by id from API', function() {
      return pipefy.getPipeById(PIPE_ID).then(function(result) {
  ...
  describe('#getPhaseById', function() {
    it('should return phase data by id from API', function() {
      return pipefy.getPhaseById(PHASE_ID).then(function(result) {
  ...
  describe('#getCardsByPipeId', function() {
    it('should return cards data by pipe id from API', function() {
      return pipefy.getCardsByPipeId(PIPE_ID).then(function(result) {
  ...
  describe('#getCardById', function() {
    it('should return card data by id from API', function() {
      return pipefy.getCardById(CARD_ID).then(function(result) {
  ...
  describe('#getPipeRelationByIds', function() {
    it('should return pipe realtion by ids from API', function() {
      return pipefy
        .getPipeRelationByIds([PIPE_ID, CLONE_PIPE_ID])
        .then(function(result) {
          expect(JSON.parse(result)).to.have.deep.property(
            'data.pipe_relations'
          );
        });
    });
  ...
  describe('#updatePhaseField', function() {
    it('should return updated phase field from API', function() {
      return pipefy
        ...
        .then(function(result) {
          expect(JSON.parse(result)).to.have.deep.property(
            'data.updatePhaseField.phase_field'
          );
        });
    });
  });
  ...
  describe('#updateComment', function() {
    it('should return updated comment from API', function() {
      return pipefy
        .updateComment({
          id: COMMENT_ID,
          text: 'Edit: Im editing this comment'
        })
        .then(function(result) {
          expect(JSON.parse(result)).to.have.deep.property(
  ...
  describe('#updatePipeRelation', function() {
    it('should return updated pipe relation from API', function() {
      return pipefy
        ...
        .then(function(result) {
          expect(JSON.parse(result)).to.have.deep.property(
            'data.updatePipeRelation.pipe_relation'
          );
        });
    });
  });
  ...
  describe('#moveCardToPhase', function() {
    it('should return moved card from API', function() {
      return pipefy
        .moveCardToPhase({ card_id: CARD_ID, destination_phase_id: PHASE_ID })
        .then(function(result) {
          expect(JSON.parse(result)).to.have.deep.property(
            'data.moveCardToPhase.card'
          );
        });
    });
  });
  ...
  describe('#deleteComment', function() {
    it('should return success on delete comment from API', function() {
      ...
      return pipefy.deleteComment(COMMENT_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
  ...
  describe('#deleteCard', function() {
    it('should return success on delete card from API', function() {
      ...
      return pipefy.deleteCard(CARD_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deleteCard.success'
        );
      });
    });
  });
  ...
  describe('#deletePhaseField', function() {
    it('should return success on delete phase field from API', function() {
      ...
      return pipefy.deletePhaseField(PHASE_FIELD_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deletePhaseField.success'
        );
      });
    });
  });
  ...
  describe('#deletePhase', function() {
    it('should return success on delete phase from API', function() {
      ...
      return pipefy.deletePhase(PHASE_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deletePhase.success'
        );
      });
    });
  });
  ...
  describe('#deleteLabel', function() {
    it('should return success on delete label from API', function() {
      ...
      return pipefy.deleteLabel(LABEL_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deleteLabel.success'
        );
      });
    });
  });
  ...
  describe('#deletePipeRelation', function() {
    it('should return success on delete pipe relation from API', function() {
      ...
      return pipefy.deletePipeRelation(PIPE_RELATION_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deletePipeRelation.success'
        );
      });
    });
  });
  ...
  describe('#deletePipe', function() {
    it('should return success on delete pipe from API', function() {
      ...
      return pipefy.deletePipe(CLONE_PIPE_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deletePipe.success'
        );
      });
    });
  });
  ...
  describe('#deleteOrganization', function() {
    it('should return success on delete organization from API', function() {
      return pipefy.deleteOrganization(ORGANIZATION_ID).then(function(result) {
        expect(JSON.parse(result)).to.have.deep.property(
          'data.deleteOrganization.success'
        );
      });
    });
  });
